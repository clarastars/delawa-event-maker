...
Route::prefix('admin')->name('admin.')->group(function (): void {
    ...
    Route::middleware('auth')->group(function (): void {
        ...
        Route::middleware(EnsureUserIsAdmin::class)->group(function (): void {
            ...
            Route::post('/vouchers/generate', [VoucherGenerateController::class, 'store'])->name('vouchers.generate.store');
            ...
            Route::post('/contacts/{contact}/vouchers/{voucher}/redeem', [ContactController::class, 'redeemVoucher'])->name('contacts.redeem-voucher');
